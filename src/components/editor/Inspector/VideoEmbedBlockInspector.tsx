    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Select value={data.platform} onValueChange={(value: 'youtube' | 'vimeo') => updateNodeData({ platform: value })}>
        ...
        <div className="space-y-2">
          ...
          {!isValidUrl && data.url && (
            <p className="text-xs text-red-500">
              Please enter a valid {data.platform} URL
            </p>
          )}
        </div>
        ...
        {/* Caption */}
        <div className="space-y-2">
          <Label htmlFor="video-caption" className="text-xs">Caption (Optional)</Label>
          <Textarea
            id="video-caption"
            value={data.caption || ''}
      ...
      <div className="space-y-3">
        ...
        {/* Horizontal Padding */}
        <div className="space-y-2">
          <Label htmlFor="video-padding-x" className="text-xs">Horizontal Padding</Label>
          <div className="flex items-center gap-2">
            <Slider
              id="video-padding-x"
              min={0}
        ...
        {/* Vertical Padding */}
        <div className="space-y-2">
          <Label htmlFor="video-padding-y" className="text-xs">Vertical Padding</Label>
          <div className="flex items-center gap-2">
            <Slider
              id="video-padding-y"
              min={0}
        ...
        {/* Border Radius */}
        <div className="space-y-2">
          <Label htmlFor="video-border-radius" className="text-xs">Border Radius</Label>
          <div className="flex items-center gap-2">
            <Slider
        ...
        {/* Background Color */}
        <div className="space-y-2">
          <Label htmlFor="video-bg-color" className="text-xs">Background Color</Label>
          <div className="flex items-center gap-2">
            <Input
              id="video-bg-color"
              type="color"
        ...
        {(data.borderWidth || 0) > 0 && (
          <>
            {/* Border Width */}
            <div className="space-y-2">
              <Label htmlFor="video-border-width" className="text-xs">Border Width</Label>
              <div className="flex items-center gap-2">
                <Slider
            ...
            {/* Border Color */}
            <div className="space-y-2">
              <Label htmlFor="video-border-color" className="text-xs">Border Color</Label>
              <div className="flex items-center gap-2">
                <Input
