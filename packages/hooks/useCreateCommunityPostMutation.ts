  ...
  return useMutation({
    ...
    onMutate: async variables => {
      ...
      const optimisticPost = {
        ...
        title: variables.title, // Now mandatory, no fallback needed
        content: variables.content || '', // Now optional with empty string default
        ...
        link_preview_data: variables.link_preview_data || null,
